export default function PrivacyPage() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Articles page.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Articles page, accessible from{" "}
            <a
              href="https://nextjs-labs.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://nextjs-labs.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: nightmare.owl16@gmail.com</li>
      </ul>
    </>
  );
}
